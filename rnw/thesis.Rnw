...
% description: Duke PhD Thesis R-no-weave Template
...
<<knitr-setup, echo=F, cache=F, results='hide'>>=
# set global knitr options

library(knitr)

opts <- list(tidy=F, message=F, warning=F, 
	     fig.width=6, fig.height=4.5)
do.call(knitr::opts_chunk$set, opts)
...
\begin{singlespace} % force code chunks to be single spaced

<<<hello, results='markup'>>=
